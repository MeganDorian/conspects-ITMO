...
[0. Введение](#introduction)
   ...
   5. [Старт потока (Java): реализация Runnable vs наследование от Thread](#start)
[1. Многопоточность или IPC](#multiipc)

[2. Завершение потоков](#thread_ending)

[3. Примитивы синхронизации](#primitives)

[4. Алгоритмы синхронизации](#sync_algos)

[5. Атомарные снимки регистров](#atomic_snaps)

[6. Ошибки || программирования](#prog_mistakes)

[7. Модель памяти](#memory_model)
   1. [](#)
   1. [](#)
   1. [](#)

[8. Профилирование многопоточных приложений](#profiling)

[9. Flat-Combining](#FC)

[10. RCU](#rcu)

[11. Транзакционная память](#tm)

[12. Асинхронный ввод/вывод](#async)
   1. [Блокирующий/неблокирующий](#block)
   2. [Синхронный (реактор)/асинхронный (проактор)](#sync_async)
      1. [Шаблон Proactor](#proactor)
      2. [Реализация async operations processor](#aop)
         1. [Функции мультиселектор](#func_mult)
         2. [ОС](#OS)
   3. [Библиотеки асинхронного ввода/вывода](#async_libs)
      1. [Асинхронный сервер](#async_server)
      2. [Корутины](#coroutines)

[13. Линеаризуемость](#linear)

[14. OpenMP](#openmp)

[15. Intel TBB](#tbb)

[16. Акторная модель](#actor_model)
   1. [Суть модели](#model)
   2. [Erlang и BEAM](#erlang)
   3. [Elixir](#elixir)
...
## <a name="multiipc"></a> 1. Многопоточность или IPC
...
## <a name="thread_ending"></a> 2. Завершение потоков
...
## <a name="primitives"></a> 3. Примитивы синхронизации
...
![notify all внутри, чтобы дать гарантию об актуальности монитора](image-2.png)
...
## <a name="sync_algos"></a> 4. Алгоритмы синхронизации
...
![](assets/20240125_145147_image.png)
...
## <a name="atomic_snaps"></a> 5. Атомарные снимки регистров
...
## <a name="prog_mistakes"></a> 6. Ошибки || программирования
...
## <a name="memory_model"></a> 7. Модель памяти
...
## <a name="profiling"></a> 8. Профилирование многопоточных приложений
...
## <a name="tm"></a> 11. Транзакционная память
...
## <a name="async"></a> 12. Асинхронный ввод/вывод

### <a name="block"></a> Блокирующий/неблокирующий
...
### <a name="sync_async"></a>Синхронный (реактор)/асинхронный (проактор)
...
#### <a name="proactor"></a> Шаблон Proactor
...
#### <a name="aop"></a> Реализация async operations processor

Существует 2 возможные реализации:

##### <a name="func_mult"></a> Функции мультиселектор
...
### <a name="async_libs"></a> Библиотеки асинхронного ввода/вывода
